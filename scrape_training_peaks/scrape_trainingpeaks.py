...
def scrape_data():
    ...
    for row in row_divs:
        ...
        try:
            ...
            profile_link = profile_image_div.find_element(
                By.TAG_NAME, "a"
            ).get_attribute("href")
...
def scrape_contact(coaches):
    ...
    for coach in coaches:
        ...
        try:
            ...
            # Extract website
            try:
                website_element = contact_section.find_element(
                    By.CSS_SELECTOR, ".profile-website-url-container a"
                )
            ...
            # Extract address
            try:
                address_element = contact_section.find_element(
                    By.XPATH,
                    "//strong[contains(text(), 'Address:')]/ancestor::div[@class='row']//p",
                )
            ...
            try:
                email_element = contact_section.find_element(
            ...
            print(
                f"Scraped {coach['name']}: Website={website}, Address={address}, Email={email}"
            )
